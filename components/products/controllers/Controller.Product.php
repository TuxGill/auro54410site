<?php
  ...
  function getAllproducts($pdo){
    $sql= "select * from product where act_product=1 and del_product=0";
          ...
          $row['color_product'],
           ...
           $row['pdf_product'] ,
            ...
            $row['link1_product'],
             ...
             $row['order_product'],
             $row['act_product'],
              $row['del_product'],$row['ts_product']);
  ...
  function getProductByCategoryId($pdo, $id){
    $sql= "select * from product  where  fk_id_product_category=".$id." and act_product=1 and del_product=0";
