...
<div class="row conteudo conteudo-grupo col-sm-12">
	...
	<div class="col-sm-11 offset-sm-1 col-lg-11 col-xl-11 offset-xl-1">
		<ul>
			...
			<li><p><em>Verticalmente integrada,</em>desde a I&ampD à comercialização</p></li>
			<li><p>Exportação para <em>mais de 150 países</em></p></li>
			<li><p>2 centros de <em>pesquisa e desenvolvimento</em></p></li>
			<li><p><em>18 fábricas</em> com os mais recentes equipamentos</p></li>
			<li><p><em>Mais de 15 mil toneladas</em> de princípios ativos farmacêuticos produzidos anualmente</p></li>
			<li><p><em>Capacidade para produzir</em> formulações das mais convencionais às mais complexas</p></li>
			<li><p><em>Instalações aprovadas</em> pelo INFARMED, USFDA, UKMHRA, Health Canada, MCC- South Africa,<br>
	     		ANVISA – Brasil, TGA-Australia, GCC DR, etc.</p></li>
		</ul>
	</div>
</div>