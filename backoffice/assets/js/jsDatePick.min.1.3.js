g_l = [];
g_l.MONTHS = ["Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"];
g_l.DAYS_3 = ["Dom", "Seg", "Ter", "Qua", "Qui", "Sex", "Sab"];
g_l.MONTH_FWD = "Avançe um mês";
g_l.MONTH_BCK = "Recue um mês";
g_l.YEAR_FWD = "Avançe um ano";
g_l.YEAR_BCK = "Recue um ano";
g_l.CLOSE = "Fechar o calendário";
g_l.ERROR_2 = g_l.ERROR_1 = "Data inválida!";
g_l.ERROR_4 = g_l.ERROR_3 = "Target invalid";
g_jsDatePickImagePath = "../backoffice/img/calendar/";
...
JsDatePick.prototype.setConfiguration = function(a) {
    ...
    this.oConfiguration.cellColorScheme = (a.cellColorScheme != null) ? a.cellColorScheme : "armygreen";
    this.oConfiguration.dateFormat = (a.dateFormat != null) ? a.dateFormat : "%m-%d-%Y";
    this.oConfiguration.imgPath = (g_jsDatePickImagePath.length != null) ? g_jsDatePickImagePath : "../img/calendar/";
