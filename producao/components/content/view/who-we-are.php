...
<div class="slider">
  ...
  <div class="subtitle">
    <p class="col-sm-6 offset-sm-1 col-8 offset-1"><?php echo utf8_encode($aurovitas[0]->getIntro()); ?></p>
  </div>
</div>
...
<div class="row conteudo conteudoQuemSomos col-sm-12">
    ...
    <h2><?php echo utf8_encode($conteudo[1]->getTitle()); ?></h2>

    <p>
      <?php echo utf8_encode($conteudo[1]->getText()); ?>
    </p>
      ...
      <h2 class="col-sm-12 h2Aurovitas"><?php echo $conteudo[$i]->getTitle(); ?></h2>
        <div class="row col-sm-12 marginValores">
          ...
          <div class="col-sm-12 col-md-6 col-lg-5 col-xl-5 textos">
            <h2><?php echo utf8_encode($conteudo[$i]->getTitle()); ?></h2>
            <div>
              <h3><?php echo utf8_encode($conteudo[$i]->getIntro()); ?></h3>
              <p>
                 <?php echo utf8_encode($conteudo[$i]->getText()); ?>
              </p>
            </div>
          </div>
           <div class="col-sm-0 col-md-1 col-lg-1 col-xl-1 line  row-eq-height">
