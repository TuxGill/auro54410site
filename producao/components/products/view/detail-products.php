...
<div class="row conteudo conteudoProd col-sm-12">
  ...
  <?php if($productContent[0]->getLogo()!=''){ ?>
    ...
    <div>
      <?php echo utf8_encode($productContent[0]->getText()); ?>
		</div>
    <?php
                ...
                <div class="row col-sm-12 prodFer">
                  ...
                  <div class="col-sm-12 col-md-7 col-lg-6 col-xl-6 textos">
                    <h2 style="color:<?php echo $produtosFerlidona[$i]->getColor(); ?>">
                      <?php echo utf8_encode($produtosFerlidona[$i]->getTitle()); ?>
                    </h2>
                    <h3>
                      <?php echo utf8_encode($produtosFerlidona[$i]->getIntro()); ?>
                    </h3>
                    <p>
                        <?php echo utf8_encode($produtosFerlidona[$i]->getText()); ?>
                    </p>
                  </div>
                   <div class="col-sm-0 col-md-1 col-lg-1 col-xl-1 line  row-eq-height">
                      <img src="../images/line.svg" onerror="this.onerror=null; this.src='line.png'">
