...
<div class="row conteudo col-sm-12">
    ...
    <?php echo utf8_encode($productsCategory[0]->getText());  ?>

		<div class="header2">
			<h2>  <?php echo utf8_encode($productsCategory[0]->getLabel());  ?></h2>
		</div>
     ...
     ?>
          ...
          <a class="linkProdutos" href="<?php echo BASE_URL."/detalhe-produto/".$products[$i]->getSlug();?>">
        		<div class="row decubal">
                    ...
                    <div>
          			         <p class="title-destaque"><?php echo utf8_encode($products[$i]->getTitle());  ?></p>
          			       <p class="txt-destaque"><?php echo utf8_encode($products[$i]->getIntro());  ?></p>
                    </div>
          			  </div>
