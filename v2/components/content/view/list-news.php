...
<div class="slider">
  ...
  <div class="subtitle">
    <p class="col-sm-6 offset-sm-1"><?php echo utf8_encode($noticiasCategory[0]->getIntro());  ?></p>
  </div>
</div>
          ...
          <div class="row">
              ...
              <div class="col-sm-12 col-md-6 col-lg-5 col-xl-5 textos row-eq-height">
                <div>
                  ...
                  <h2>
                    <?php echo utf8_encode($conteudo[$i]->getTitle()); ?>
                  </h2>
                  <h3>
                    <?php echo utf8_encode($conteudo[$i]->getIntro()); ?>
                  </h3>
                  <p>
